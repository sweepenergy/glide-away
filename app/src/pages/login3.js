...
function Login() {
    ...
    useEffect(() => {
        axios.post({
            ...
            .then((response) => {
                setUserInfo({
                    auth_key: response.session_id,
                    auth_token: response.session_token,
                    authStatus: true,
                })
            })

        if(userInfo.authStatus == true){
            const apiCredit = userInfo.auth_key + ':' + userInfo.auth_token;
            ...
            axios.get({
                ...
                .then((response) => {
                    setUserInfo({
                        api_key: response.active.api_key,
                    })
                })
        }
    });
